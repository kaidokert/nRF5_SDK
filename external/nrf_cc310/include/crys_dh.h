...
#define CRYS_DH_MAX_SIZE_OF_OTHER_INFO_ENTRY  CRYS_KDF_MAX_SIZE_OF_OTHER_INFO_ENTRY /*!< Size is in bytes */
#define CRYS_DH_MAX_SIZE_OF_KEYING_DATA  CRYS_KDF_MAX_SIZE_OF_KEYING_DATA /*!< Size is in bytes*/
...
*/
#define CRYS_DH_PKCS3_GeneratePubPrv(rndContext_ptr, Generator_ptr,GeneratorSize,\
				Prime_ptr,PrimeSize,\
				L,\
				tmpPubKey_ptr,tmpPrimeData_ptr,\
				ClientPrvKey_ptr,ClientPrvKeySize_ptr,\
				ClientPub_ptr,ClientPubSize_ptr)\
		_DX_DH_GeneratePubPrv(rndContext_ptr, (Generator_ptr),(GeneratorSize),\
				(Prime_ptr),(PrimeSize),\
				(L),\
...
*/
#define CRYS_DH_ANSI_X942_GeneratePubPrv(rndContext_ptr, Generator_ptr,GeneratorSize,Prime_ptr,PrimeSize,\
				Q_ptr,QSize,\
				tmpPubKey_ptr,tmpPrimeData_ptr,\
				ClientPrvKey_ptr,ClientPrvKeySize_ptr,\
				ClientPub_ptr,ClientPubSize_ptr)\
...
@return CRYS_OK on success.
@return A non-zero value on failure as defined in crys_dh_error.h or crys_kdf_error.h.
*/
